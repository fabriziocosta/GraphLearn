...
def display( G,size=15,font_size=15,node_size=200,node_border=False,delabeledges=True,contract=False,vertex_label='label'):
...
def row_drawgraph_wrapper( G,size=15,font_size=15,node_size=200,node_border=False,contract=True,deleteedges=True):
    ...
    row_draw_graph(G2, size=size, node_size=node_size, node_border=node_border,font_size=font_size,vertex_color='color')
