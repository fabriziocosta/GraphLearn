...
class RnaGraphManager(object):
    ...
    def get_base_graph(self):
        ...
        if 'directed_base_graph' not in self.__dict__:
            self.directed_base_graph = graphlearn01.minor.rna_graphmanager.expanded_rna_graph_to_digraph(self.base_graph)
...
def get_sequence(digraph):
    ...
    current,end= graphlearn01.minor.rna_graphmanager.get_start_and_end_node(digraph)
