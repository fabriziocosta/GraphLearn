...
import graphlearn01.minor.rna_my_abstract
import graphlearn01.minor.rna_graphmanager
...
def get_mod_dict(graph):
    s,e= graphlearn01.abstract_graphs.rna_graphmanager.get_start_and_end_node(graph)
